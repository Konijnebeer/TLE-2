        ...
        <form action="{{ route('quests.update') }}" method="POST" class="border border-gray-300 p-4 rounded-lg">
            ...
            <div class="mb-4">
                ...
                >
                    ...
                    <option class="text-black" disabled
                            value="" {{ old('difficulty_level', $quest->difficulty_level) == null ? 'selected' : '' }}>
                        Kies uw moeilijkheidsgraad
                    </option>
                    <option value="1" {{ old('difficulty_level', $quest->difficulty_level) == "1" ? 'selected' : '' }}>
                        Makkelijk
                    </option>

                    <option value="2" {{ old('difficulty_level', $quest->difficulty_level) == "2" ? 'selected' : '' }}>
                        Gemiddeld
                    </option>

                    <option value="3" {{ old('difficulty_level', $quest->difficulty_level) == "3" ? 'selected' : '' }}>
                        Moeilijk
            ...
            <div class="mb-4">
                ...
                >
                    >
                    <option class="text-black" disabled
                            value="" {{ old('category', $quest->category) == null ? 'selected' : '' }}>
                        Kies uw categorie
                    </option>
                    ...
                    @foreach(QuestCategory::cases() as $category)
                        ...
                        <option
                            value="{{$category->value}}" {{ old('category', $quest->category) == $category->value ? 'selected' : '' }}>
